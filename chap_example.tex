...
Both Adaptive Metropolis and Delayed Rejection can be implemented together to give a Delayed Rejection Adaptove Metropolis scheme, as was first implemented by \citet{Laine2008}. % List the advantages a combination offers.
...
\begin{table}[H]
	...
	\hline
	Blocked parameter update & 35.83\% \\
	\hline
	\end{tabular}
