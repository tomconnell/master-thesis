...
\begin{figure}[H]
	\centering
	\includegraphics[scale=1]{initialchains.pdf}
...
\end{bmatrix}^T$, to constitute reasonably sufficent summary statistics for the banana distribution. However, these are not perfect, and the effect of using them will be the introduction of some degree of bias into the ABC posterior. \par
