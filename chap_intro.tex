...
\begin{algorithm}[H]
	...
	\begin{algorithmic}
		...
		\State 3. If the candidate state is better than the previous state, i.e $\alpha_{ABC} > 1$, then the candidate state is accepted unconditionally meaning $\bm{\theta_i} = \bm{\theta^*}$
